...
vendedores de uma empresa de consórcio para 
...
podemos afirmar que:\r\n
I -> A frequência absoluta de clientes atendidos 
na segunda-feira é de 25 clientes.\r\n
II -> A frequência absoluta de clientes 
atendidos pela Daniela é de 22 clientes.\r\n
III -> A frequência absoluta de clientes 
atendidos na sexta-feira é de 27 clientes.
...
na sexta-feira:\r\n5 + 8 + 6 + 8 = 27'),
(50,1,1,2,
'A respeito das medidas estatísticas 
denominadas amplitude e desvio, 
assinale a alternativa correta:',
'O desvio é uma medida de dispersão 
calculada sobre cada um dos valores 
de um conjunto de informações.',
'Em estatística, não existem diferenças 
entre desvio e desvio padrão, exceto pelo nome.',
'A amplitude é uma medida de tendência 
central usada para encontrar um único 
valor que representa todos os valores 
de um conjunto.',
'O desvio é um número relacionado à 
dispersão total de um conjunto de 
valores.','\r\n'),
...
que apresenta a frequência absoluta (fi) 
de um elemento (xi) cuja frequência 
relativa (fr) é igual a 25% e cujo total de 
elementos (N) da amostra é igual a 72.',
'18','36\r\n',
'9\r\n',
'54\r\n',
'Resolução: 18\r\nComo a frequência 
relativa é de 25%, sabemos que\r\n
fi : 72 = 25%\r\nfi : 72 = 0,25\r\n
fi = 0,25 * 72\r\nfi = 18'),
